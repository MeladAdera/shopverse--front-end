  ...
  return (
    <>
      ...
      <div className="hidden md:block w-full">
        <div className="w-full flex justify-between items-center gap-8 lg:gap-10 px-4 md:px-[5%] lg:px-10">
          ...
          <div className="flex justify-between items-center shrink-0 gap-4 lg:gap-6">
            <button className="text-[16px] lg:text-[18px] hover:text-gray-600 transition-colors px-3 lg:px-4 py-2 font-medium">
              Shop
            </button>
            <button className="text-[16px] lg:text-[18px] hover:text-gray-600 transition-colors px-3 lg:px-4 py-2 font-medium">
              On Sale
          ...
          <div className="flex gap-3 lg:gap-4 shrink-0">
            ...
            <button className="hover:bg-gray-100 rounded-full p-2 transition-colors">
              <CircleUser className="w-5 h-5 lg:w-6 lg:h-6" />
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="w-full flex justify-between items-center px-4 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Sheet>
              ...
              {/* Drawer Content */}
              <SheetContent side="left" className="w-[280px] sm:w-[320px] p-0 bg-amber-50">
