...
function Header() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    if (searchQuery.trim()) {
      ...
      setShowMobileSearch(false); // إغلاق البحث بعد البحث الناجح
    }
  };
  ...
  return (
    <>
      ...
      <div className="hidden lg:block w-full sticky top-0 bg-white z-40 border-b">
      ...
      <div className="lg:hidden w-full sticky top-0 bg-white z-40 border-b">
        
        {/* شريط البحث للجوال - يظهر عندما showMobileSearch = true */}
        {showMobileSearch ? (
          <div className="w-full px-4 py-3 border-b bg-white animate-in slide-in-from-top duration-200">
          ...
          /* الهيدر العادي للجوال - يظهر عندما showMobileSearch = false */
