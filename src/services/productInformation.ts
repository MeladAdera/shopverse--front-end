...
// import type { ApiResponse, Product,  ProductsApiResponse, ReviewsApiResponse } from "@/types/product";
...
//   async getProductFAQs(productId: number | string): Promise<ApiResponse> {
//     try {
...
//   async getRelatedProducts(categoryId: number, excludeProductId: number): Promise<ProductsApiResponse> {
//     try {
